...
app.use("/", require("./routes/paymentHistory"));
app.use("/", require("./routes/manage-appointments"));
app.use("/", require("./routes/accept-appointment"));
app.use("/", require("./routes/cancel-appointment"));
